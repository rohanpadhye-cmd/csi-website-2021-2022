            ...
            <Container fluid className='ml-md-3 mt-md-4 d-none d-md-flex'>
                <Row>
                    <Col md={{span: 5}}>
                        ...
                        <div className='contact-text mt-md-2' style={{ fontSize: '12px' }}>
                        ...
                        <Container fluid className="ml-md-5">
                            <Row>
                                <Col className="mt-md-1" md={{span: 12}}>
                                    ...
                                    <span className='contact-text mt-md-2 ml-md-2' style={{fontSize: '12px'}}>
                                        csi.vesit@ves.ac.in
                                    </span> 
                                </Col>
                                <Col className="mt-md-3" md={{span:12}}>
                                    <Row>
                                        ...
                                        <Col>
                                            <div className='contact-text' style={{ fontSize: '12px' }}>
                                                Jatin Bhagchandani:
                                            </div>
                                            <div className='contact-text' style={{ fontSize: '12px' }}>
                                                +91 96194 47077
